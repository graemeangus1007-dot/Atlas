...
/**
 * Read-only preview of a generated website draft (editing in Sprint 20.0C).
 */
export default function AiDraftPreview({ draft }: Props) {
  return (
    <section
    ...
    >
      ...
      <p className="text-xs text-muted">
        Read-only preview — editing arrives in Sprint 20.0C.
      </p>
    </section>
  );
}
